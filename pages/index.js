    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.mixcloud}>
          <iframe width="100%" height="60" src="https://www.mixcloud.com/widget/iframe/?hide_cover=1&mini=1light=1&feed=%2Fconrad-soundsystem%2Fclubmusic-2021%2F" frameborder="0" />
